...
basketball <- fromJSON('G:/DATABASE/City_Council/Public_Advocate/Parks/parks_data/DPR_Basketball_001.json') %>% as.data.frame()
...
bocce <- fromJSON('G:/DATABASE/City_Council/Public_Advocate/Parks/parks_data/DPR_Bocce_001.json') %>% as.data.frame()
...
cricket <- fromJSON('G:/DATABASE/City_Council/Public_Advocate/Parks/parks_data/DPR_Cricket_001.json') %>% as.data.frame()
...
handball <- fromJSON('G:/DATABASE/City_Council/Public_Advocate/Parks/parks_data/DPR_Handball_001.json') %>% as.data.frame()
...
tracks <- fromJSON('G:/DATABASE/City_Council/Public_Advocate/Parks/parks_data/DPR_RunningTracks_001.json') %>% as.data.frame()
...
tennis <- fromJSON('G:/DATABASE/City_Council/Public_Advocate/Parks/parks_data/DPR_Tennis_001.json') %>% as.data.frame()
...
parks <- reduce(.x=dats_lats, function(x,y) st_join(x,y, left=TRUE),.init=park_shapes)
